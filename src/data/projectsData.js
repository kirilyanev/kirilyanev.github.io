const projectsData = [
  ...
  },
  {
    ...
    image: 'runner.png',
    snapshot: 'infinite-runner-snapshot.png',
    alt: 'Platform-game',
    url: 'url to be added once game deployed',
    description: 'Platformer game',
    info: 'This is my first platform game i made following a tutorial for building games with pixijs.'
  },
];
